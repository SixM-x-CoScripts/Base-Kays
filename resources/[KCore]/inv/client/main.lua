...
function CreatePedScreen(firstTime)
    ...
    local duration = -1
    print('On request ' .. animDict)
    RequestAnimDict(animDict)
    while HasAnimDictLoaded(animDict) == false do
        print('AAAAAAHHHH  ' .. animDict)
        RequestAnimDict(animDict)
        Wait(50)
    end
    print('Animation ' .. animDict .. ' chargée')

    print(DoesEntityExist(clonedPed) .. ' < existe ?')
    TaskPlayAnim(clonedPed, animDict, animName, 2.0, 2.0, duration, 1, 0, false, false, false)
    --TaskPlayAnim(PlayerPedId(), animDict, animName, 2.0, 2.0, duration, 1, 0, false, false, false)
    TaskPlayAnim(clonedPed, animDict, animName, 8.0, 8.0, duration, 50, 0, false, false, false)
