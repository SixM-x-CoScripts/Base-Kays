...
--     if not isRoll then
--         if xPlayer ~= nil then
--             if not t[xPlayer.UniqueID] then
--                 isRoll = true
...
--                         TriggerClientEvent('esx:showNotification', xPlayer.source,'Vous avez avez gagnez du pain et de l\'eau')
...
--                         TriggerClientEvent('esx:showNotification', xPlayer.source,'Vous avez gagnez '.. _money .. ' $')
...
--                         -- xPlayer.addAccountMoney('cash',_blackMoney * 2)
--                         TriggerClientEvent('esx:showNotification', xPlayer.source,'Vous avez gagnez de l\'argent sale')
--                     elseif _priceIndex == 5 then
--                         -- print("Win 300,000$")
--                         xPlayer.addAccountMoney('cash',300000)
--                         TriggerClientEvent('esx:showNotification', xPlayer.source, 'Vous avez gagnez 300 000$')
--                     elseif _priceIndex == 12 then
--                         -- print("Win ak gold")
--                         xPlayer.addWeapon("weapon_knife",255)
--                         TriggerClientEvent('esx:showNotification', xPlayer.source,'Vous avez gagnez un Couteau')
--                     elseif _priceIndex >= 19 then
--                         -- print("Win car lp700r")
--                         TriggerClientEvent("esx_tpnrp_luckywheel:winCar", _source)
--                         TriggerClientEvent('esx:showNotification', xPlayer.source, 'Vous avez gagnez la voiture')
--                     end
...
--                             TriggerClientEvent('esx:showNotification', xPlayer.source,'Vous avez gagnez une AK 47')
--                         elseif _priceIndex >= 19 then
--                             -- print("Win car lp700r")
--                             TriggerClientEvent("esx_tpnrp_luckywheel:winCar", _source)
--                             TriggerClientEvent('esx:showNotification', xPlayer.source, 'Vous avez gagnez la voiture')
...
--                 else
--                     TriggerClientEvent("esx_tpnrp_luckywheel:rollFinished", -1)    
--                     TriggerClientEvent('esx:showNotification', _source, 'Vous ne possedez pas assez de sous sur vous')
--                 end
--             end
--         end
--     end
