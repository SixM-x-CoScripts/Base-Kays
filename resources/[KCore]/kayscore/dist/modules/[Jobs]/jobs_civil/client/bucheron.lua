...
--	end
--
--	ZGEG.Game.SpawnLocalPed(2, `s_m_y_construct_01`, zone.Bucheron, 289.13, function(ped)
...
--		ZGEG.Game.SpawnLocalPed(2, `s_m_y_construct_01`, v.pos, v.Heading, function(ped)
--			FreezeEntityPosition(ped, true)
...
--			local done = false
--			TriggerServerEvent("jobs_civil:bucheron:addPosition", zoneRandom)
--			
--			ZGEG.Game.SpawnLocalObject(model, zoneRandom, function(object)
...
--					ZGEG.ShowHelpNotification("~INPUT_CONTEXT~ pour travailler")
--
...
--						local done = false
--						
--						ZGEG.Game.SpawnLocalObject(`prop_ld_fireaxe`, vector3(0.0, 0.0, 0.0), function(object)
...
--						exports['pogressBar']:drawBar(10000, "Travail en cours")
--						Wait(10000)
--						TriggerServerEvent("jobs_civil:bucheron:getBuche")
...
--						local done = false
--						
--						ZGEG.Game.SpawnLocalObject(`prop_tree_log_02`, vector3(0.0, 0.0, 0.0), function(object)
...
--						ClearPedTasksImmediately(PlayerPedId())
--
--						TriggerServerEvent("jobs_civil:bucheronReward")
--
--						break
--					end
--				end
