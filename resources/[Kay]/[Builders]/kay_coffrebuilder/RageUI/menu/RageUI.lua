    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "commonmenu" then
                         RenderSprite(CurrentMenu.Sprite.Dictionary, CurrentMenu.Sprite.Texture, CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.ItSAMS.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Title.Background.Height, CurrentMenu.Sprite.Color.R, CurrentMenu.Sprite.Color.G, CurrentMenu.Sprite.Color.B, CurrentMenu.Sprite.Color.A)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y , RageUI.Settings.ItSAMS.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Title.Background.Height, 87, 7, 198, 255)
                    end
                else
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.ItSAMS.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Title.Background.Height, CurrentMenu.Rectangle.R, CurrentMenu.Rectangle.G, CurrentMenu.Rectangle.B, CurrentMenu.Rectangle.A)
                end
            else
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.ItSAMS.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Title.Background.Height, CurrentMenu.Rectangle.R, CurrentMenu.Rectangle.G, CurrentMenu.Rectangle.B, CurrentMenu.Rectangle.A)
            end
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local Glarewidth = RageUI.Settings.ItSAMS.Title.Background.Width
                ---@type number
                local Glareheight = RageUI.Settings.ItSAMS.Title.Background.Height
                ---@type number
            ...
            RenderText(CurrentMenu.Title, CurrentMenu.X + RageUI.Settings.ItSAMS.Title.Text.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUI.Settings.ItSAMS.Title.Text.Y, CurrentMenu.TitleFont, CurrentMenu.TitleScale, 255, 255, 255, 255, 1)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset, RageUI.Settings.ItSAMS.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 10, 10, 10, 210)
                RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Subtitle, CurrentMenu.X + RageUI.Settings.ItSAMS.Subtitle.Text.X, CurrentMenu.Y + RageUI.Settings.ItSAMS.Subtitle.Text.Y + RageUI.ItemOffset, 0, RageUI.Settings.ItSAMS.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUI.Settings.ItSAMS.Subtitle.Background.Width + CurrentMenu.WidthOffset)
                ...
                if CurrentMenu.Display.PageCounter then
                    if CurrentMenu.PageCounter == nil then
                        RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Index .. " / " .. CurrentMenu.Options, CurrentMenu.X + RageUI.Settings.ItSAMS.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUI.Settings.ItSAMS.Subtitle.PreText.Y + RageUI.ItemOffset, 0, RageUI.Settings.ItSAMS.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    else
                        RenderText(CurrentMenu.PageCounter, CurrentMenu.X + RageUI.Settings.ItSAMS.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUI.Settings.ItSAMS.Subtitle.PreText.Y + RageUI.ItemOffset, 0, RageUI.Settings.ItSAMS.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    end
                end
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.ItSAMS.Background.Y + CurrentMenu.SubtitleHeight, RageUI.Settings.ItSAMS.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.ItSAMS.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 25, 25, 25, 225)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.ItSAMS.Background.Y + CurrentMenu.SubtitleHeight, RageUI.Settings.ItSAMS.Background.Width + CurrentMenu.WidthOffset, RageUI.ItemOffset, 0, 0, 0, 120)

            -- RenderSprite(RageUI.Settings.ItSAMS.Background.Dictionary, RageUI.Settings.ItSAMS.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUI.Settings.ItSAMS.Background.Y + CurrentMenu.SubtitleHeight, RageUI.Settings.ItSAMS.Background.Width + CurrentMenu.WidthOffset, RageUI.ItemOffset, 0, 0, 0, 0, 255)
...
function RageUI.IsVisible(Menu, ItSAMS, Panels)
